...
import { Briefcase, Target, Wallet, Calculator, GitCompare, Link as LinkIcon } from "lucide-react";
    ...
    <div className="space-y-4 pb-20">
      ...
      <Tabs value={tab} onValueChange={setTab}>
        <TabsList className="grid w-full grid-cols-3 md:grid-cols-6">
          ...
          <TabsTrigger value="mapping"><LinkIcon className="mr-1 h-4 w-4" /> Mapping</TabsTrigger>
        ...
        <TabsContent value="mapping" className="mt-4"><BrokerCompanyMapping /></TabsContent>
