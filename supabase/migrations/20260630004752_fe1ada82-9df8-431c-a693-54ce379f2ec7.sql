...
BEGIN
  ...
  INSERT INTO public.super_admin_audit_log (super_admin_id, action_type, target_company_id, description, old_value)
  VALUES (auth.uid(), 'company_deleted', _company_id, 'Cascade delete via super_admin_delete_company: '||COALESCE(_co.name,''), to_jsonb(_co));
